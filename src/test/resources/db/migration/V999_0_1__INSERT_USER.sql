...
VALUES ('a3dc28ce-39e5-4797-8d7a-f6809b6f1f03'::uuid, 'testUser1110@example.com', 'password', CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP, 'jfdsjisfjjlsjfsljfsji');
...
VALUES ('dbf52753-f0e2-4171-8f05-bb216e2864d7'::uuid, 'a3dc28ce-39e5-4797-8d7a-f6809b6f1f03'::uuid,
       ...
       ('579c71d1-18ab-4894-977e-f6f156dbb6c4'::uuid, 'a3dc28ce-39e5-4797-8d7a-f6809b6f1f03'::uuid,
        '3a5bef20-b6c1-4b83-8844-058e123d479d'::uuid, 'USER');

INSERT INTO users (id, email, password, created_at, updated_at, email_verification_code)
VALUES ('7ed1259c-aee0-4ce7-b297-f9a090b2735a'::uuid, 'testAdmin1121@example.com', 'password', CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP, 'jfdsjisfjjlsjfsljfsji');
